...
public class FromPythonToJava extends Application
{
	
	public FromPythonToJava()
	{
	}
	...
	public void welcome(Stage myStage) 
	{
		...
		myStage.setTitle("From Python to Java - Welcome");
		myStage.setScene(sceneWelcome);
		myStage.show();
		Rectangle2D screenBound = Screen.getPrimary().getVisualBounds();
		myStage.setX((screenBound.getWidth() - myStage.getWidth()) / 2);
		myStage.setY((screenBound.getHeight() - myStage.getHeight()) / 2);
	}//end welcome method
	...
	public void continueProgram(TextField txtUserFName, TextField txtUserLName, Stage myStage)
	{
		...
		continueStage.setTitle("From Python to Java - ... - Lesson Menu - Continue");
		continueStage.setScene(sceneContinue);
		continueStage.show();
		Rectangle2D screenBound = Screen.getPrimary().getVisualBounds();
		continueStage.setX((screenBound.getWidth() - continueStage.getWidth()) / 2);
		continueStage.setY((screenBound.getHeight() - continueStage.getHeight()) / 2);
	...
	public void instructions(Stage myStage)
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - Welcome - Instructions");
...
//		vbxIntro.getChildren().add(hbxexampleImages);
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - Introduction");
...
//
//		Button btnExtra = new Button("Extra Practice");
...
//			}//end try catch
//		});
//		vbxLessonMenu.getChildren().add(btnExtra);
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson Menu");
	...
	public void doExtraPractice(Stage myStage)
	{
		myStage.setOnHiding( event -> {try {
			exitProgram();
		} catch (IOException e) {
	...
	public void error(Stage myStage)
	{
		...
		errorStage.setTitle("From Python to Java - ... - Lesson Menu - Error");
		errorStage.setScene(sceneError);
		errorStage.show();
		Rectangle2D screenBound = Screen.getPrimary().getVisualBounds();
		errorStage.setX((screenBound.getWidth() - errorStage.getWidth()) / 2);
		errorStage.setY((screenBound.getHeight() - errorStage.getHeight()) / 2);
	}//end error method
	...
	public void lesson1(Stage myStage)throws NullPointerException
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #1");
	...
	public void lesson2(Stage myStage) throws NullPointerException
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #2");
	...
	public void lesson3(Stage myStage)
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #3");
	...
	public void lesson4(Stage myStage)
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #4");
	...
	public void lesson5(Stage myStage) throws NullPointerException
	{
		...
		Text textL5T4m = new Text(" at the start, the returned value will be rounded to the nearest whole number and returned as an integer value."
				...
				+ "\nOne will be an integer variable called randomInt and initialized to a random integer within "
				+ "a given range (you can try different ranges as well for different attempts).\nThe other will be a double variable called "
				+ "randomDouble and initialized to a random decimal between 0 and 1."
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #5");
	...
	public void lesson6(Stage myStage) throws NullPointerException
	{
		...
		Text textL6T1c = new Text(" in Python, the code would look similar to below.");
		...
		TextFlow textflowL6T2 = new TextFlow(textL6T2a, textL6T2b, textL6T2c, textL6T2d, textL6T2e, textL6T2f, textL6T2g, textL6T2h);
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #6");
	...
	public void lesson7(Stage myStage) throws NullPointerException
	{
		...
		Text textL7T2am = new Text(". In the creation, initialize ");
		...
		Text textL7T2as = new Text(" to the captial of Ireland. Do not initialize the user response variables. Ask the user what the capital of Canada is, assign it to the value of ");
		...
		textL7T3b.setFill(Color.BLACK);
		Text textL7T3c = new Text("month");
		textL7T3c.setFill(Color.rgb(121, 76, 52));
		Text textL7T3d = new Text(" and initialize it to 0. \nNext, ask the user what month number it is (1=January, 6=June,..., 12=December). \nAfter that, use a switch case statement to print out the month the user has chosen. If the user has chosen a number less than 1 or greater than 12, by default print an error statement to the screen.");
		textL7T3d.setFill(Color.BLACK);
		TextFlow textflowL7T3 = new TextFlow(textL7T3a, textL7T3b, textL7T3c, textL7T3d);
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #7");
	...
	public void lesson8(Stage myStage) throws NullPointerException
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #8");
	...
	public void lesson9(Stage myStage) throws NullPointerException
	{
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #9");
...
//			}//end if
		...
		//setting/showing the stage
		myStage.getIcons().add(new Image("FromOneToAnotherLogo.png"));
		myStage.setTitle("From Python to Java - ... - Lesson #10");
